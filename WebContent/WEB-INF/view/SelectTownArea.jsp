...
<%
	//YubinCsvData yubinData = (YubinCsvData) request.getAttribute("yubinData");
	//List<YubinCsvData> yubinData = (ArrayList<YubinCsvData>)request.getAttribute("yubinData");
	...
	//else
	//{
	//	System.out.println("[town.jsp]CityCode = " + yubinData.get(0).getCityCode());
	//}
%>
...
<body>
	<div class="yubintop">
		<span class="yubinmain">郵便番号検索</span><span class="yubinsub">（町域選択画面）</span>
	</div>
	<div class="boxall">
		...
		<div>
			<form method="post" name="toResult" action="/yubin/Result">
			<input type="hidden" id="townCode" name="townCode" value="none">
			<input type="button" name="town" value="郵便番号検索" onClick="resultSubmit()">
	    	</form>
		</div>
	</div>
</body>
